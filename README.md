...
- 桌宠空闲时采用低频漫游：移动后播放等待动画并停留 20–40 秒；“自由运动”关闭后则停在当前位置，仅播放状态动画和原地反应。
- 右键桌宠可快速打开 Codex、切换自由运动、打开自定义宠物目录与设置，或收回宠物。
- 桌宠仅在宠物与等级标识附近响应鼠标，透明窗口边缘不会阻挡下方应用操作。
- 鼠标悬浮桌宠后可拖动右上角轻量手柄，或直接使用滚轮/触控板，将宠物本体调整为 `50%–200%`；等级标识保持固定尺寸，宠物大小和位置会在重启后恢复。
